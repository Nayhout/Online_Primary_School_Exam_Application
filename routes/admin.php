...
use App\Http\Controllers\SmStaffIDCardController;
...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::get('student-attendance-detail', ['as' => 'student_attendance_detail', 'uses' => 'StudentAttendanceDetailController@studentAttendanceDetail']);
        Route::post('student-attendance-detail', 'StudentAttendanceDetailController@studentSearchAttType');
        ...
        // Student Re-study Report
        Route::get('student-exam-report', ['as' => 'student_exam_report', 'uses' => 'SmReportController@StudentReExamReport']);
        Route::post('student-exam-report', ['as' => 'student_exam_report', 'uses' => 'SmReportController@StudentReExamReportSearch']);
        ...
        // Staff ID Card
        Route::resource('staff-id-card', 'SmStaffIDCardController');
        Route::get('generate-staff-id-card', ['as' => 'generate_staff_id_card', 'uses' => 'SmStaffIDCardController@generateStaffIDCard']);
        Route::post('generate-staff-id-card-search', ['as' => 'generate_staff_id_card_search', 'uses' => 'SmStaffIDCardController@generateStaffIdCardSearch']);
        Route::get('generate-staff-id-card-search', ['as' => 'generate_staff_id_card_search', 'uses' => 'SmStaffIDCardController@generateStaffIdCard']);
        Route::get('generate-staff-id-card-print/{staff_id}/{depart_id}', 'SmStaffIDCardController@generateStaffIDCardPrint');

        // Pick UP Student

        Route::get('pick-up', ['as' => 'pick_up', 'uses' => 'PickUpStudentController@pickupList']);
        Route::get('add-pickup', ['as' => 'add_pickup', 'uses' => 'PickUpStudentController@pickupAdd']);
        Route::post('pickup-store', ['as' => 'pickup_store', 'uses' => 'PickUpStudentController@pickupStore']);
        Route::post('pick-up', ['as' => 'search_pickup', 'uses' => 'PickUpStudentController@searchPickup']);
        Route::get('view-pickup/{id}', ['as' => 'viewPickup', 'uses' => 'PickUpStudentController@pickupView']);
        Route::get('delete-pickup-view/{id}', ['as' => 'deletePickupView', 'uses' => 'PickUpStudentController@deletePickupView']);
        Route::get('deletePickup/{id}', 'PickUpStudentController@deletePickup');
        Route::get('pickup-directory', ['as' => 'pickup_directory', 'uses' => 'PickUpStudentController@pickupList']);



        // Generate Pick Up
        Route::get('generate-pick-up/{id}', ['as' => 'generate_pick_up', 'uses' => 'PickUpStudentController@printPickUp']);
        Route::get('generate-pickup-card-print/{s_id}', 'PickUpStudentController@generatePickupCardPrint');
        ...
        Route::get('history/{id}', ['as' => 'history', 'uses' =>'SmStudentAdmissionController@History']);
        ...
        // staff Promote
        Route::get('staff-promote', ['as' => 'staff_promote', 'uses' => 'SmStaffController@staffPromote']);

        Route::get('staff-current-search', ['as' => 'staff_current_search', 'uses' => 'SmStaffController@staffPromote']);
        Route::post('staff-current-search', 'SmStaffController@staffCurrentSearch');
        Route::get('staff-current-search-custom', 'SmStaffController@staffPromoteCustom');
        Route::post('staff-current-search-custom', 'SmStaffController@staffCurrentSearchCustom');
        Route::get('staff-promote-store', 'SmStaffController@staffPromote');
        Route::post('staff-promote-store', 'SmStaffController@staffPromoteStore');
        Route::get('staff-promote-store-custom', 'SmStaffController@staffPromoteCustom');
        Route::post('staff-promote-store-custom', 'SmStaffController@staffPromoteCustomStore');
        ...
        Route::get('student-scholarship', ['as' => 'student_scholarship', 'uses' => 'SmFoundationReportController@studentScholarship']);
        Route::post('student-scholarship', ['as' => 'student_scholarship', 'uses' => 'SmFoundationReportController@studentScholarshipSearch']);

        Route::get('student-private', ['as' => 'student_private', 'uses' => 'SmFoundationReportController@studentPrivate']);
        Route::post('student-private', ['as' => 'student_private', 'uses' => 'SmFoundationReportController@studentPrivateSearch']);
        ...
        Route::get('download-address/{file_name}', function ($file_name = null) {
            $file = public_path() . '/uploads/address/' . $file_name;
            if (file_exists($file)) {
                return Response::download($file);
            }
        });
        ...
        /// Examination Date
        Route::get('/examination-date', 'SmSystemSettingController@ExaminationDate');
        Route::get('/add-examination-date', 'SmSystemSettingController@ExaminationCreate')->name('add-examination-date');
        Route::post('/store-examination-date', 'SmSystemSettingController@storeExaminationDate')->name('store-examination-date');
        Route::get('/examination-date/{id}',  'SmSystemSettingController@EditExaminationDate')->name('EditExaminationDate');
        Route::post('/update-examination-date',  'SmSystemSettingController@UpdateExaminationDate')->name('UpdateExaminationDate');
        Route::get('delete-examination-date/{id}', ['as' => 'DeleteExaminationDate', 'uses' => 'SmSystemSettingController@DeleteExaminationDate'])->name('DeleteExaminationDate');
        Route::get('DeleteExamDate/{id}', 'SmSystemSettingController@DeleteExamDate');

        /// Generation Student
        Route::get('generate-student', ['as' => 'generate_student', 'uses' => 'SmSystemSettingController@GerationView']);
        Route::get('/add-generate-student', 'SmSystemSettingController@AddGenerationStudent')->name('add-generate-student');
        Route::post('generate-store', ['as' => 'generate_store', 'uses' => 'SmSystemSettingController@Generatestore']);
        Route::get('generate-edit/{id}', ['as' => 'generate_edit', 'uses' => 'SmSystemSettingController@Generateedit']);
        Route::post('generate-update', ['as' => 'generate_update', 'uses' => 'SmSystemSettingController@Generateupdate']);
        Route::get('delete-generate-student/{id}', ['as' => 'DeleteGenerateStudent', 'uses' => 'SmSystemSettingController@DeleteGenerateStudent']);
        Route::get('generate-delete/{id}', ['as' => 'generate_delete', 'uses' => 'SmSystemSettingController@GenerateDelete']);
...
//        Route::get('section-delete/{id}', ['as' => 'section_delete', 'uses' => 'SmSectionController@delete']);
        ...
        /// Faculty
        Route::get('faculty', ['as' => 'faculty', 'uses' => 'SmSystemSettingController@index']);

        Route::post('faculty-store', ['as' => 'faculty_store', 'uses' => 'SmSystemSettingController@FacultyStore']);
        Route::get('faculty-edit/{id}', ['as' => 'faculty_edit', 'uses' => 'SmSystemSettingController@FacultyEdit']);
        Route::post('faculty-update', ['as' => 'faculty_update', 'uses' => 'SmSystemSettingController@FacultyUpdate']);
        Route::get('faculty-delete/{id}', ['as' => 'faculty_delete', 'uses' => 'SmSystemSettingController@FacultyDelete']);

        /// Building
        Route::get('building', ['as' => 'building', 'uses' => 'SmSystemSettingController@Building']);

        Route::post('building-store', ['as' => 'building_store', 'uses' => 'SmSystemSettingController@BuildingStore']);
        Route::get('building-edit/{id}', ['as' => 'building_edit', 'uses' => 'SmSystemSettingController@BuildingEdit']);
        Route::post('building-update', ['as' => 'building_update', 'uses' => 'SmSystemSettingController@BuildingUpdate']);
        Route::get('building-delete/{id}', ['as' => 'building_delete', 'uses' => 'SmSystemSettingController@BuildingDelete']);
        Route::get('/register-continue', 'RegisterContinueController@index')->name("register-continue");
        Route::get('register-student/{id}', ['as' => 'register_student', 'uses' => 'RegisterContinueController@storeRegisterSearch']);
        Route::get('/re-study' ,'RegisterContinueController@ReStudy');


        Route::get('/degree-statistic', 'DegreeStatisticController@index');
        Route::get('/associate-degree-statistic', 'AssociateDegreeStatisticController@index');
        Route::get('/re-exam', 'RegisterContinueController@ReExam');
        Route::get('/associate-degree-foreign', 'RegisterContinueController@AssociateStaticDegreeForeign')->name('associate-degree-foreign');
        Route::get('/degree-foreign', 'RegisterContinueController@StaticDegreeForeign')->name('degree-foreign');
        Route::get('/master-degree-foreign', 'MasterDegreeController@index');
        Route::get('/doctor-degree-foreign', 'DoctorDegreeController@index');
        Route::get('/disability_associate_degree', 'RegisterContinueController@AssociateDisabilityDegree');
        Route::get('/disability_master_degree', 'RegisterContinueController@MasterDegreeDisability');
        Route::get('/disability_doctor_degree', 'RegisterContinueController@DoctorDegreeDisability');
        Route::get('/graduated_associate_degree', 'RegisterContinueController@GraduateAssociate');
        Route::get('/graduated_master_degree', 'RegisterContinueController@GraduateMasterAssociate');
        Route::get('/graduated_degree', 'RegisterContinueController@GraduateDegree');
        Route::get('/graduated_doctor_degree', 'RegisterContinueController@GraduateDoctorDegree');
        Route::get('/dropout_associate_degree', 'RegisterContinueController@DropoutAssociateDegree');
        Route::get('/dropout_degree', 'RegisterContinueController@DropoutDegree');
        Route::get('/dropout_master_degree', 'RegisterContinueController@DropoutMasterDegree');
        Route::get('/dropout_doctor_degree', 'RegisterContinueController@DropoutDoctorDegree');
        Route::get('/degree_disability_statistics', 'RegisterContinueController@DisabilityDegree');
        Route::get('/overlap_associate_degree', 'RegisterContinueController@OverlapAssociateDegree');
        Route::get('/overlap_degree', 'RegisterContinueController@OverlapDegree');
        Route::get('/overlap_master_degree', 'RegisterContinueController@OverlapMasterDegree');
        Route::get('/overlap_doctor_degree', 'RegisterContinueController@OverlapDoctorDegree');
        Route::get('/associate_age_degree', 'RegisterContinueController@AssociateAgeDegree');
        Route::get('/master_age_degree', 'RegisterContinueController@MasterAgeDegree');
        Route::get('/doctor_age_degree', 'RegisterContinueController@DoctorAgeDegree');
        Route::get('/age_degree', 'RegisterContinueController@AgeDegree');
        Route::get('/master_degree', 'RegisterContinueController@MasterDegree');
        Route::get('/doctor_statistic_degree', 'RegisterContinueController@DoctorDegree');
        Route::get('/count_staff', 'RegisterContinueController@CountStaff');
        Route::get('/list_staff', 'RegisterContinueController@ListStaff');
        Route::get('/lists_name_staff', 'RegisterContinueController@ListNameStaff');
        Route::get('/training_permit_law', 'RegisterContinueController@TrainingPermitLaw');
        Route::get('/cooperation', 'RegisterContinueController@Cooperation');
        Route::get('/physical_material', 'RegisterContinueController@PhysicalMaterial');

        Route::get('degree', ['as' => 'degree', 'uses' => 'DegreeStatisticController@Degrees']);

        Route::post('degree-store', ['as' => 'degree_store', 'uses' => 'DegreeStatisticController@DegreesStore']);
        Route::get('degree-edit/{id}', ['as' => 'degree_edit', 'uses' => 'DegreeStatisticController@DegreesEdit']);
        Route::post('degree-update', ['as' => 'degree_update', 'uses' => 'DegreeStatisticController@DegreesUpdate']);
        Route::get('degree-delete/{id}', ['as' => 'degree_delete', 'uses' => 'DegreeStatisticController@DegreesDelete']);

        // Import Room

        Route::get('import-room', ['as' => 'import_room', 'uses' => 'SmClassRoomController@importRoom']);
        Route::get('download_room_file', ['as' => 'download_room_file', 'uses' => 'SmClassRoomController@downloadRoomFile']);
        Route::post('room-bulk-store', ['as' => 'room_bulk_store', 'uses' => 'SmClassRoomController@roomBulkStore']);

        // Student Certificate
        Route::get('foundation', ['as' => 'foundation', 'uses' => 'FoundationController@Foundation']);
        Route::get('search-foundation', 'FoundationController@Foundation');
        Route::post('search-foundation', ['as' => 'searchFoundation', 'uses' => 'FoundationController@searchFoundation']);
        Route::get('view-foundation/{id}', ['as' => 'viewFoundation', 'uses' => 'FoundationController@ViewFoundation']);
        Route::get('/temporary-certificate/{id}/{exam_date?}', ['as' => 'viewCertificate', 'uses' => 'TemporaryCertificateController@index']);

        // Create Major
        Route::get('majors', ['as' => 'majors', 'uses' => 'FoundationController@Major']);


        Route::post('majors-store', ['as' => 'majors_store', 'uses' => 'FoundationController@MajorStore']);
        Route::get('majors-edit/{id}', ['as' => 'majors_edit', 'uses' => 'FoundationController@edit']);
        Route::post('majors-update', ['as' => 'majors_update', 'uses' => 'FoundationController@update']);
        Route::get('majors-delete/{id}', ['as' => 'majors_delete', 'uses' => 'FoundationController@delete']);


        // Degree Report
        Route::get('student_degree_report', ['as' => 'student_degree_report', 'uses' => 'DegreeStatisticController@StaticDegree']);


        Route::get('ajaxStudentMajor', 'DegreeStatisticController@ajaxStudentMajor');
        Route::get('ajaxSelectSemester', 'DegreeStatisticController@ajaxSelectSemester');

        // staff designation
        Route::get('ajaxStaffDesignation','SmStaffIDCardController@ajaxStaffDesignation');
        Route::post('addNewTask','SmStaffIDCardController@addNewTask');
        Route::post('updateToDo/{id}','SmStaffIDCardController@updateToDo');


        // Student Exam Type
        Route::get('student_exam_type_report', ['as' => 'student_exam_type_report', 'uses' => 'RegisterContinueController@StudentExamType']);
        Route::post('student_exam_type_report', ['as' => 'student_exam_type_report', 'uses' => 'RegisterContinueController@StudentExamTypeSearch']);
        Route::get('exam-type/print/{exam_id}/{class_id}/{section_id}/{type}',  'RegisterContinueController@StudentExamTypePrint');

        // Create Semester
        Route::get('semester', ['as' => 'semester', 'uses' => 'SmSemesterController@index']);

        Route::post('semester-store', ['as' => 'semester_store', 'uses' => 'SmSemesterController@store']);
        Route::get('semester-edit/{id}', ['as' => 'semester_edit', 'uses' => 'SmSemesterController@edit']);
        Route::post('semester-update', ['as' => 'semester_update', 'uses' => 'SmSemesterController@update']);
        Route::get('semester-delete/{id}', ['as' => 'semester_delete', 'uses' => 'SmSemesterController@delete']);

        // Create To Do List
        Route::resource('to-do-list', 'HomeController');
        Route::get('to-do-list', ['as' => 'to_do_list', 'uses' => 'HomeController@ToDoLists']);
        Route::get('delete-todo-list/{id}', 'HomeController@deleteToDoLists');
        Route::get('delete-todo/{id}', 'HomeController@deleteToDo');

        Route::get('change-task', 'HomeController@TaskChange');
    });
});