...
class SmStudentCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $student_types = SmStudentCategory::where('school_id',Auth::user()->school_id)
                ->orderBy('id','DESC')
                ->get();
          //  dd($student_types);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $student_type->percentage = $request->percentage;
            $student_type->categories_description = $request->description;
            $student_type->fix_amount = $request->fix_amount;
