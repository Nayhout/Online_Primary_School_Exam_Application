...
//            dd($classes);
    ...
    public function studentDetailSearch(Request $request)
    {
        $input = $request->all();
...
//                                $import->out_time = $value->out_time;
                                ...
                                $import_student = new SmStudentAttendanceImport();
                                $import_student->student_id = $student->id;
                                $import_student->attendance_date = date('Y-m-d', strtotime($value->attendance_date));
                                $import_student->attendance_type = 'P';
                                $import_student->in_time = $value->in_time;
                                $import_student->out_time = $value->out_time;
                                $import_student->notes = $value->notes;
                                $import_student->created_by = Auth::user()->id;
                                $import_student->school_id = Auth::user()->school_id;
                                $import_student->save();
                            }
                        }
