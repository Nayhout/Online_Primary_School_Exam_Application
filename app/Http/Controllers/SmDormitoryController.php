...
class SmDormitoryController extends Controller
{
    ...
    public function studentDormitoryReport(Request $request)
    {
        try{
            ...
            $rooms= SmRoomList::where('active_status', 1)->where('school_id',Auth::user()->school_id)->get();
            ...
            return view('backEnd.dormitory.student_dormitory_report', compact('classes', 'students', 'dormitories','rooms'));
        }catch (\Exception $e) {
