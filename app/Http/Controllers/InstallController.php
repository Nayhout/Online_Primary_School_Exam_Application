...
class InstallController extends Controller
{
    ...
    public function index()
    {
        if (Schema::hasTable('sm_general_settings') && Schema::hasTable('users')) {
            ...
            try {
                Session::put('system_admin_email', "ksmart.lion@gmail.com");
                Session::put('system_admin_password', "ksmart.lion@gmail.com");
                ...
                if (Schema::hasTable('migrations')) {
                    ...
                    if (count($migration) > 0) {
                        ...
                        $setting->school_name = "DEMO";
                        $setting->email = "ksmart.lion@gmail.com";
                        $setting->system_purchase_code = "XXXXXXX";
                        $setting->system_activated_date = date('Y-m-d');
                        $setting->system_domain = "XXXX";
                        $setting->save();
                    }
                    ...
                    $user->role_id = 1;
                    $user->username = "ksmart.lion@gmail.com";
                    $user->full_name = 'System Administrator';
                    $user->email = "ksmart.lion@gmail.com";
                    $user->password = Hash::make("ksmart.lion@gmail.com");
                    $user->save();
                    ...
                    $staff->email  = "ksmart.lion@gmail.com";
                    $staff->save();
                    return redirect('/login');
                }
            } catch (\Exception $e) {
