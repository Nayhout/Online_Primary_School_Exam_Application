        ...
        for ($i = 1; $i <= 20; $i++) {
            ...
            for ($class_id = 1; $class_id <= 1; $class_id++) {
                for ($section_id = 1; $section_id <= 1; $section_id++) {
                    ...
                    $studentEmail = strtolower($student_User_Name) . $i . '@gmail.com';
                    ...
                    $newUser->email     = strtolower($Father_User_Name) . $i . '@gmail.com';
                    $newUser->username  = strtolower($Father_User_Name) . $i . '@gmail.com';
                    $newUser->password  = Hash::make(123456);
                    ...
                    $parent->guardians_email      = $Guardian_First_Name . $i . '@gmail.com';
