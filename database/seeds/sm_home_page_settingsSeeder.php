...
class sm_home_page_settingsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $s->long_title = 'CLOUD';
        $s->short_description = 'Managing various administrative tasks in one place is now quite easy and time savior with this CLOUD and Give your valued time to your institute that will increase next generation productivity for our society.';
