...
// for current address in Staff Add Module
    var currentfileInput = document.getElementById('current_address');
    if (currentfileInput) {
        //alert("staffs photo");
        currentfileInput.addEventListener('change', showFileName);

        function showFileName(event) {
            var currentfileInput = event.srcElement;
            var fileName = currentfileInput.files[0].name;
            document.getElementById('placeholderCurrentAddress').placeholder = fileName;
        }
    }
