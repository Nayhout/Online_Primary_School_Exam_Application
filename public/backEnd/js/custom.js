(function($) {
    ...
    // Pickup part
    $(document).on("click", ".generate-pickup-print", function(event) {
        var url = $("#url").val();
      ...
      //  console.log(pickup);
       ...
       // console.log($(this).val());
        ...
        if (len.length > 8) {
            ...
            $("#genearte-pickup-print-button").attr("href", "javascript:;");
            $("#genearte-pickup-print-button").removeAttr("target");
        } else if (sList != "") {
            $("#genearte-pickup-print-button").attr(
                "href",
                url + "/generate-pickup-card-print/" + sList
            );
            $("#genearte-pickup-print-button").attr("target", "_blank");
        } else {
    ...
    $(document).on("click", ".generate-pickup-print-all", function(event) {
        var url = $("#url").val();
        var sList = "";
        var len = new Array();
    ...
    $(document).on("click", "#genearte-pickup-print-button", function(event) {
    ...
    $(document).ready(function() {
        ...
        $("#select_faculty").on("change", function() {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: url + "/" + "ajaxStudentMajor?id="+ id,
                success: function(data) {
                    $("#select_major_div .current").html("SELECT MAJOR *");
                    $("#select_major").find("option").not(":first").remove();
                    $("#select_major_div ul").find("li").not(":first").remove();
        ...
        $("#select_academic").on("change", function() {
            var url = $("#url").val();
            //console.log($(this).val());
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: url + "/" + "ajaxSelectSemester?id="+ id,
                success: function(data) {
                    $("#select_semester_div .current").html("SELECT SEMESTER *");
                    $("#select_semester").find("option").not(":first").remove();
                    $("#select_semester_div ul").find("li").not(":first").remove();

                    $.each(data, function(i, item) {
                        if (item.semester_code) {
                            $("#select_semester").append(
                                $("<option>", {
    ...
    //  generate-staff-id-card-print

    $(document).on("click", ".generate-staff-id-card-print", function(event) {
        var url = $("#url").val();
        var staff_id_card = $("#staff_id_card").val();
        console.log(staff_id_card);

        var staffList = "";
        var len = new Array();
        $("input[type=checkbox]").each(function() {
            if (this.checked) {
                staffList += staffList == "" ? $(this).val() : "-" + $(this).val();
                len.push($(this).val());
            }
        });

        if (len.length > 8) {
            toastr.warning("You can not select more than 8 staff!");
            $("#generate-staff-id-card-print-button").attr("href", "javascript:;");
            $("#generate-staff-id-card-print-button").removeAttr("target");
        } else if (staffList != "") {
            $("#generate-staff-id-card-print-button").attr(
                "href",
                url + "/generate-staff-id-card-print/" + staffList + "/" + staff_id_card
            );
            $("#generate-staff-id-card-print-button").attr("target", "_blank");
        } else {
            //toastr.error('Please select student!');
            $("#generate-staff-id-card-print-button").attr("href", "javascript:;");
            $("#generate-staff-id-card-print-button").removeAttr("target");
    ...
    $(document).on("click", ".generate-staff-id-card-print-all", function(event) {
        var url = $("#url").val();
        var staff_id_card = $("#staff_id_card").val();
        var staffList = "";
        var len = new Array();
    ...
    $(document).on("click", "#genearte-staff-id-card-print-button", function(event) {
        var num = $("input[type=checkbox]:checked").length;
    ...
    $(document).on("click", "#generate-staff-id-card-print-button", function(event) {
        var num = $("input[type=checkbox]:checked").length;
    ...
    $("#select_department").on("change", function() {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: url + "/" + "ajaxStaffDesignation?id="+ id,
            success: function(data) {
                $("#select_designation_div .current").html("SELECT DESIGNATION *");
                $("#select_designation").find("option").not(":first").remove();
                $("#select_designation_div ul").find("li").not(":first").remove();

                $.each(data, function(i, item) {
                    if (item.id) {
                        $("#select_designation").append(
                            $("<option>", {
                                value: item.id,
                                text: item.title,
                            })
                        ...
                        $("#select_designation_div ul").append(
                            "<li data-value='" +
                            item.id +
                            "' class='option'>" +
                            item.title +
