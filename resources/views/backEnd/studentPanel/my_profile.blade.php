                    ...
                    <div class="white-box radius-t-y-0">
                        ...
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="value">
                                   {{@$student_detail->className != ""? @$student_detail->className->class_name:''}} ({{@$student_detail->session_id != ""? @$academic_year->year:''}}-{{@$student_detail->session_id != ""? @$academic_year->year+1:''}})
                                </div>
                            </div>
                        </div>
                        <div class="single-meta">
...
{{--                    @endif--}}
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade  show active" id="studentProfile">
                        <div class="white-box">
                            <h4 class="stu-sub-head">@lang('Personal') @lang('lang.info')</h4>
