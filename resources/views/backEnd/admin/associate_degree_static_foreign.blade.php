    ...
    <div id="check-site">
        <table>
            <div>
                ...
                <br>
                <div style="text-align: center">ស្ថិតិនិស្សិត <space style="font-family: 'Khmer Moul'">បរទេស</space> កំពុងសិក្សា <space style="font-family: 'Khmer Moul'">ថ្នាក់បរិញ្ញាបត្ររង</space>  សម្រាប់ឆ្នាំសិក្សា២០១៩-២០២០</div>
            </div>
        </table>
