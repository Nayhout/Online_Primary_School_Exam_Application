...
{{--            <tr>  --}}
        <div class="card" id="cars">
            @foreach($students as $student)
                ...
                ?>
                <div class="sub-card" style="margin-top: 5px">
                    <div class="pic" id="pics">
                        ...
                        <p><img src="{{ @$student->student_photo != "" ? asset(@$student->student_photo) : asset('public/backEnd/img/student/id-card-img.jpg') }}" alt="" class="box-pic" id="box-pics"></p>
                    </div>
                    <div class="infor" width="95%" >
                        ...
                        <div class="infor_detail" style="text-align: left">
                            @if(@$id_card->student_name == 1)
                                <h2 id="name">ឈ្មោះ : {{@$student->bank_name}}</h2>
                            @endif
                            <h2 id="name">Name: {{@$student->first_name}}&nbsp;{{@$student->last_name}}</h2>
                            <h2 id="name">ជំនាញ: {{@$major->name}}</h2>
                            <h2 id="name">កម្រិត:  {{@$degree->name}}</h2>
                            <h2 id="name">អត្តលេខ: {{@$student->roll_no}}</h2>
                        </div>
