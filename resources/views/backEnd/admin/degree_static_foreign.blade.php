    ...
    <div id="check-site">
        <table>
            <div>
                ...
                <div style="font-size: 24px">ឈ្មោះគ្រឹះស្ថានសិក្សា: សាកលវិទ្យាល័យស្វាយរៀង</div>
                <br>
                <div style="text-align: center;font-size: 23px">ស្ថិតិនិស្សិត <space style="font-family: 'Khmer Moul'">បរទេស</space> កំពុងសិក្សា <space style="font-family: 'Khmer Moul'">ថ្នាក់បរិញ្ញាបត្រ</space>  សម្រាប់ឆ្នាំសិក្សា២០១៩-២០២០</div>
            </div>
        </table>
            ...
            <table class="mt-30 mb-20 table table-striped table-bordered ">
                <thead class="border">
                    <tr>
                        ...
                        <th rowspan="3" width="20%">ដេប៉ាតឺម៉ង់</th>
                        <th rowspan="3" width="20%">ឯកទេស/ជំនាញ</th>
                        <th rowspan="3">រយៈពេល ប.ប</th>
                        <th colspan="6">ឆ្នាំទី១</th>
                        <th colspan="6">ឆ្នាំទី២</th>
                        <th colspan="6">ឆ្នាំទី៣</th>
                        <th colspan="6">ឆ្នាំទី៤</th>
                        <th colspan="6">ឆ្នាំទី៥</th>
