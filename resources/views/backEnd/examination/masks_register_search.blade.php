            ...
            <div class="col-lg-12">
                <table class="display school-table school-table-style" cellspacing="0" width="100%" >
                    ...
                    <tbody>                        
                            ...
                            ?>
                                <td>
                                    ...
                                    <div class="input-effect mt-10">
                                        ...
                                        ?>
                                        <input class="primary-input marks_input" type="number" name="marks[{{$student->id}}][{{$part->id}}]" value="{{!empty($search_mark)?$search_mark:0}}" {{@$absent_check->attendance_type == 'A'? 'readonly':''}}>
                        ...
                        @endforeach
                        @if(in_array(224, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 || Auth::user()->role_id == 11)
                            <tr>
