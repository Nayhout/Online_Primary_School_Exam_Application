...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('Examination Date')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.student_information')</a>
                <a href="#">@lang('Examination Date')</a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                @if(in_array(65, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                    <div class="col-lg-12 text-md-right text-left col-md-6 mb-30-lg col-sm-6 text_sm_right">
                        <a href="{{route('add-examination-date')}}" class="primary-btn small fix-gr-bg">
            ...
            <div class="row">
                <div class="col-lg-4 no-gutters">
                    <div class="main-title">
                        <h3 class="mb-0">Examination Date</h3>
                    </div>
                </div>
            </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{route('EditExaminationDate', $row->id)}}">@lang('lang.edit')</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mt-40 d-flex justify-content-between">
                                                ...
                                                <a href="{{url('DeleteExamDate/'.$row->id)}}" class="text-light">
