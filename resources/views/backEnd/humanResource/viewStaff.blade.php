...
{{$staffDetails->date_of_birth != ""? App\SmGeneralSettings::DateConvater($staffDetails->date_of_birth):''}}
    ...
    <div class="single-info">
        <div class="row">
            <div class="col-lg-5 col-md-6">
                <div class="">
                    @lang('Passport / National ID')
                </div>
            </div>

            <div class="col-lg-7 col-md-7">
                <div class="">
                    @if(isset($staffDetails)){{$staffDetails->identity}}@endif
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-7 col-md-6">
            <div class="">
                @if(isset($staffDetails)){{$staffDetails->current_address}}@endif
                    <a href="{{url('download-address/'.showAddress($staffDetails->current_address))}}">
            ...
            <div class="">
                ...
                <div class="single-info">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="">
                                @if(isset($staffDetails)){{$staffDetails->telegram_url}}@endif
                            </div>
                        </div>
                    </div>
                </div>
