                        ...
                        <div class="row mb-20">
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    ...
                                    <span class="focus-border"></span>
                                    <label>@lang('Passport / National ID')</label>
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <input class="primary-input form-control{{ $errors->has('nssf') ? ' is-invalid' : '' }}" type="text" name="nssf" value="@if(isset($editData)){{$editData->nssf}}@endif">
                                    <span class="focus-border"></span>
                            ...
                            <div class="col-lg-6">
                                 <div class="row no-gutters input-right-icon mb-20">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input form-control {{ $errors->has('staff_photo') ? ' is-invalid' : '' }}" id="placeholderStaffsName" type="text" placeholder="{{$editData->staff_photo != ""? ($editData->staff_photo):'Staff Photo'}}"
                                            readonly >
                                            <span class="focus-border"></span>
                        ...
                        <div class="row mb-30">
                            <div class="col-lg-6">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input" type="text" id="placeholderCurrentAddress" placeholder="{{isset($editData->current_address) && $editData->current_address != ""? ($editData->current_address):'current_address'}}"
                                                   readonly>
                                            <span class="focus-border"></span>
                                        </div>
                                    </div>
...
<div class="row mb-20">
    ...
    <div class="col-lg-6">
        <div class="input-effect">
            <input class="primary-input form-control{{ $errors->has('telegram_url') ? ' is-invalid' : '' }}" type="text"  name="telegram_url" value="{{$editData->telegram_url}}">
            <span class="focus-border"></span>
...
<div class="row mb-20">
    <div class="col-lg-4">
     <div class="row no-gutters input-right-icon mb-20">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input form-control {{ $errors->has('resume') ? ' is-invalid' : '' }}" type="text" placeholder="{{isset($editData->resume) && $editData->resume != ""? ($editData->resume):'Resume'}}"
...
<div class="col-lg-4">
    <div class="row no-gutters input-right-icon mb-20">
            <div class="col">
                <div class="input-effect">
                    <input class="primary-input form-control {{ $errors->has('joining_letter') ? ' is-invalid' : '' }}" type="text" placeholder="{{isset($editData->joining_letter) && $editData->joining_letter != ""? ($editData->joining_letter):'Joining Letter'}}"
...
<div class="col-lg-4">
    <div class="row no-gutters input-right-icon mb-20">
            <div class="col">
                <div class="input-effect">
                    <input class="primary-input form-control {{ $errors->has('other_document') ? ' is-invalid' : '' }}" type="text" placeholder="{{isset($editData->other_document) && $editData->other_document != ""? ($editData->joining_letter):'Others Documents'}}"
