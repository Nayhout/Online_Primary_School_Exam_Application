    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('Student Exam Type Report') </h1>
                <div class="bc-pages">
                    <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                    <a href="#">@lang('lang.reports')</a>
                    <a href="{{url('student-exam-report')}}">@lang('Student Exam Type Report')</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="admin-visitor-area">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                @endif
                <div class="white-box">
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'student_exam_type_report', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                    <div class="row">
...
{{--                                    <option value="{{@$faculty->id}}"  {{isset($faculty_id)? ($faculty_id == $faculty->name? 'selected':''):''}}>{{@$faculty->name}}</option>--}}
{{--                                @endforeach--}}
{{--                            </select>--}}
...
{{--                            <select class="w-100 bb niceSelect form-control{{ $errors->has('semester') ? ' is-invalid' : '' }}" name="semester">--}}
{{--                                <option data-display="@lang('select semester')" value="">@lang('select semester') </option>--}}
{{--                                <option value="semester1">ឆមាសទី១</option>--}}
{{--                                <option value="semester2">ឆមាសទី២</option>--}}

{{--                            </select>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 mt-30-md">--}}
{{--                            <select class="w-100 bb niceSelect form-control{{ $errors->has('degree') ? ' is-invalid' : '' }}" name="degree">--}}
{{--                                <option data-display="@lang('select degree')" value="">@lang('select degree') </option>--}}
{{--                                @foreach($degrees as $degree)--}}
{{--                                    <option value="{{@$degree->id}}" {{isset($degree_id)? ($degree_id == @$degree->id? 'selected':''):''}}>{{@$degree->name}}</option>--}}
{{--                                @endforeach--}}
{{--                            </select>--}}
...
{{--                        </div>--}}
                        ...
                        <div class="col-lg-3 mt-30-md" id="types">
                            <select class="w-100 bb niceSelect form-control{{ $errors->has('types') ? ' is-invalid' : '' }} types" id="types" name="types">
            ...
            <div class="container-fluid p-0">
                <div class="row mt-40">
                    ...
                    <div class="col-lg-8 pull-right">
                        <a href="{{url('exam-type/print', [$InputExamId, $InputClassId, $InputSectionId, $InputType])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> @lang('lang.print')</a>
                                    ...
                                    <div class="single-report-admit">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <h3>@lang('Order of Student Exam')</h3>
                                                                    <p class="mb-0">
                                                ...
                                                <h3 class="primary-color fw-500 text-center">@lang('Student Exam')</h3>
                                                <hr>
                                                    ...
                                                    <table class="w-100 mt-30 mb-20 table table-bordered meritList">
                                                        ...
                                                        @foreach($allresult_data as $row)
                                                            ...
                                                            <tr>
                                                                ...
                                                                @php
                                                                    $markslist = explode(',',optional($row)->marks_string);
                                                                    $listgrades = explode(',',optional($row)->grades_string);
                                                                   $get_subject_id = explode(',',optional($row)->subjects_id_string);
                                                                   $count=0;
                                                                   $subject_mark=[];
                                                                   $subject_grade=[];
                                                                   // $special_mark=[];
