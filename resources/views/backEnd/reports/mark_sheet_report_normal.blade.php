                                            ...
                                            <table class="custom_table">
                                                    ...
                                                    <tbody class="mark_sheet_body" >
                                                        ...
                                                        <td class="border-top" style="border-bottom: 1px solid black;">{{ $count }}</td>
                                                            ...
                                                            <p>
                                                                @php
                                                                    $subject_result=App\CustomResultSetting::getSubjectGpa($exam_type_id,optional($student_detail)->class_id,optional($student_detail)->section_id,optional($student_detail)->id,optional($data)->subject_id);
