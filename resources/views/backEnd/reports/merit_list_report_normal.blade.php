                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-lg-2">
                                            <img class="logo-img" src="{{ $generalSetting->logo }}" alt="" style="border-radius: 50%;margin-left: -250px;">
                                            </div>
                                            ...
                                            <tbody>
                                                @php $i=1; $subject_mark = []; $total_student_mark = 0; $total_student_mark_optional = 0; @endphp
                                                    ...
                                                    $student_detail=App\SmStudent::where('id','=',$row->student_id)->first();
                                                            ...
                                                            $get_optional_subject=App\SmOptionalSubjectAssign::where('student_id','=',optional($student_detail)->id)->where('session_id','=',@$student_detail->session_id)->first();
