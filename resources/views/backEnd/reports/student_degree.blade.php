                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 mt-30-md">
                                <select class="w-100 niceSelect bb form-control {{ $errors->has('degree') ? ' is-invalid' : '' }}" id="select_degree" name="degree">
                                    ...
                                    <option value="A">និស្សិតបរទេស</option>
                                    <option value="A">និស្សិតពិការ</option>
                                    <option value="A">និស្សិតបោះបង់ការសិក្សា</option>
                                    <option value="A">និស្សិតត្រួតថ្នាក់</option>
                                    <option value="A">និស្សិតតាមអាយុ</option>
{{--                                    @foreach($generations as $generation)--}}
