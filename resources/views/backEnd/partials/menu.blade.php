...
.dropdown-item:last-child .profile_single_notification {background: #000;}
                        ...
                        <ul class="nav navbar-nav mr-auto nav-buttons flex-sm-row">
                            ...
                            @endphp
                                ...
                                @if ( $settings->website_btn==1)
                                     <li class="nav-item">
                                         <a class="primary-btn white mr-10" href="https://cloud--net.com">@lang('lang.website')</a>
                                    </li>
                                @endif
                            ...
                            <li class="nav-item active">
                                <select class="niceSelect infix_session" id="infix_session">
                                    ...
                                    @foreach ($academic_years as $academic_year)
                                         <option value="{{ $academic_year->id }}" {{$year_id==$academic_year->id?'selected':''}}>{{ $academic_year->year }} - {{ $academic_year->year+1 }} [{{\Carbon\Carbon::parse($academic_year->starting_date)->format('M-d')}} To {{\Carbon\Carbon::parse($academic_year->ending_date)->format('M-d')}}]</option>
                        ...
                        <ul class="nav navbar-nav mr-auto nav-setting flex-sm-row d-none d-lg-block colortheme">
                            <li class="nav-item active">
                                <select class="niceSelect infix_theme_rtl" id="infix_theme_rtl">
                                    ...
                                    @endphp 
                                        <option value="2" {{$is_rtl==2?'selected':''}}>@lang('ltr')</option>
