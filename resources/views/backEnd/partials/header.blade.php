...
{{--        <link rel="stylesheet" href="{{asset('public/backEnd/')}}/css/rtl/style.css"/>--}}
    ...
    @else
        ...
        <link rel="stylesheet" href="{{asset('public/backEnd/')}}/css/{{@$active_style->path_main_style}}?v={{$random}}"/>
        <link rel="stylesheet" href="{{asset('public/backEnd/')}}/css/{{@$active_style->path_infix_style}}?v={{$random}}"/>
    @endif
    <style>
