                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <select class="w-100 bb niceSelect form-control{{ @$errors->has('teacher') ? ' is-invalid' : '' }}" id="select_teacher" name="teacher[]">
                                            <option data-display="@lang('lang.select_teacher') *" value="">@lang('lang.select_teacher') *</option>
{{--                                            @if(isset($assign_class_teacher))--}}
                                                @foreach($teachers as $teacher)
                                                    <option value="{{ @$teacher->id}}" {{ @$teacher->id == @$assign_class_teacher->id? 'selected':''}}>{{ @$teacher->full_name}}</option>
                                                @endforeach
{{--                                            @endif--}}
                                        </select>
{{--                                        @foreach($classes as $class)--}}
