                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-30">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('class_room') ? ' is-invalid' : '' }}" name="class_room_id" id="class_room_id">
                                                <option data-display="@lang('lang.select') @lang('lang.class_room') *" value="">@lang('lang.select') @lang('lang.class_room')</option>
                                                @foreach($classrooms as $row)
                                                    <option value="{{@$row->id}}"
                                                            @if ($row->id == @$classById->class_room_id)
                                                            selected="selected"
                                                            @endif
                                                    >{{@$row->room_no}}</option>
                                                @endforeach
                                ...
                                <div class="row mt-30">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('degree') ? ' is-invalid' : '' }}" name="degree_id" id="degree_id">
                                                <option data-display="@lang('lang.select') @lang('degree') *" value="">@lang('lang.select') @lang('lang.degree')</option>
                                                @foreach($degrees as $degree)
                                                    <option value="{{@$degree->id}}"
                                                            @if ($degree->id == @$classById->degree_id)
                                                            selected="selected"
                                                            @endif
                                ...
                                <div class="row mt-30" id="select_major_div">
                                    <div class="col-lg-12">
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($classes as $class)
                                    <?php
                                        $degree = \App\SmDegree::find($class->degree_id);
                                        $class_room = \App\SmClassRoom::find($class->class_room_id);
                                        $faculty = \App\SmFaculty::find($class->faculty_id);
                                        $major = \App\SmMajor::find($class->majors_id);
//                                        dd($class);
                                    ?>
                                <tr>
                                    <td valign="top">{{@$class->class_name}}</td>
                                    <td valign="top">{{@$class_room->room_no}}</td>
                                    <td valign="top">{{@$degree->degree_name}}</td>
                                    <td valign="top">{{@$faculty->faculty_name}}</td>
                                    <td valign="top">{{@$major->major_name}}</td>
                                    <td>
                                        <table>
                                            @php
