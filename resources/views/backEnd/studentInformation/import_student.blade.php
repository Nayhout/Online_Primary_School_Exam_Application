    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{url('student-admission')}}">@lang('lang.student_admission')</a>
                                ...
                                <div class="main-title">
                                    <div class="box-body">
                                        ...
                                        @foreach($sessions as $session)
                                            {{$session->id.'='.$session->year}}-{{$session->year+1}}
                            ...
                            <div class="col-lg-3">
                                ...
                                <select class="primary-input niceSelect w-100 bb form-control{{ $errors->has('generation_id') ? ' is-invalid' : '' }}" name="generation_id">
                                    ...
                                    @foreach($generations as $generation)
                                        <option value="{{$generation->id}}" {{old('generation_id') == $generation->id? 'selected': ''}}>{{$generation->generation_name_kh}}</option>
                                    @endforeach
