...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0" style="color: #0a0302">
        <div class="row">
                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-40 mt-30">
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <input class="primary-input  form-control{{ $errors->has('admission_number') ? ' is-invalid' : '' }}" type="text"  onkeyup="GetAdmin(this.value)" name="admission_number"
                                           value="{{$max_admission_id >0? $max_admission_id + 1 : ""}}" >
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input read-only-input" readonly type="text" id="roll_number" name="roll_number"  value="{{old('roll_number')}}">
                                    <label>@lang('lang.roll') @lang('lang.number') <span>*</span></label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    ...
                                    <label>@lang('Khmer') @lang('name') <span>*</span> </label>
                                    <span class="focus-border"></span>
                                </div>
                            </div>
                            <div class="col-lg-3">
...
{{--                            </div>--}}
                            <div class="col-lg-2">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input" type="text" name="nationality" value="{{old('nationality')}}">
...
{{--                            </div>--}}
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <select class="primary-input niceSelect w-100 bb form-control{{ $errors->has('generation_id') ? ' is-invalid' : '' }}" name="generation_id">
                                        ...
                                        <option data-display="@lang('generation name') *" value="" >@lang('generation name') <span>*</span></option>
                                        @foreach($generations as $generation)
                                            <option value="{{$generation->id}}" {{old('generation_id') == $generation->id? 'selected': ''}}>{{$generation->generation_name}}</option>
                                        @endforeach
                            ...
                            <div class="col-lg-1">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    ...
                                    <span class="focus-border"></span>
                                    <input type="checkbox" id="checkExternal" class="common-all_check btn btn-sm fix-gr-bg" name="checkAll" value="">
                                    <input type="hidden" id="external" class="primary-input" name="external" value="0">
{{--                                    <input type="checkbox" id="external" class="common-all_check btn btn-sm fix-gr-bg" name="external" value="{{old('external')}}">--}}
                                </div>
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('session') ? ' is-invalid' : '' }}" name="session" id="select_academic">
                                        ...
                                        <option value="{{$session->id}}" {{old('session') == $session->id? 'selected': ''}}>{{$session->year}}-{{$session->year+1}}</option>
                                        @endforeach
                                    </select>
                                    <span class="focus-border"></span>
...
{{--                                        @endforeach--}}
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('student_year') ? ' is-invalid' : '' }}" name="student_year">
                                        ...
                                        @foreach($student_years as $student_year)
                                            <option value="{{$student_year->id}}" {{old('student_year') == $student_year->id? 'selected': ''}}>{{$student_year->student_year_kh}}</option>
                                        @endforeach
                                    </select>
                                    <span class="focus-border"></span>
                                    @if ($errors->has('semester'))
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input" type="text" name="current_occupation_student" value="{{old('current_occupation_student')}}">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input" type="text" name="company" value="{{old('company')}}">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input" type="text" name="locations" value="{{old('locations')}}">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input" type="text" name="facebook_student" value="{{old('facebook_student')}}">
                        ...
                        <div class="parent_details" id="parent_details">
                            ...
                            <div class="row mb-40 mt-30">
                                ...
                                <div class="col-lg-3">
                                    <div class="no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input date form-control{{ $errors->has('date_of_birth_father') ? ' is-invalid' : '' }}" id="startDate" type="text"
                                                       name="date_of_birth_father" value="{{old('date_of_birth_father')}}" autocomplete="off">
                                                <label>@lang('date of birth father')</label>
                                                <span class="focus-border"></span>
                                                @if ($errors->has('date_of_birth_father'))
                                                    <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('date_of_birth_father') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-40 mt-30">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        <input class="primary-input form-control" cols="0" rows="3" name="father_address" id="father_address">{{old('father_address')}}</input>
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-lg-3">
                                    <div class="no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input date form-control{{ $errors->has('date_of_birth_mother') ? ' is-invalid' : '' }}" id="startDate" type="text"
                                                       name="date_of_birth_mother" value="{{old('date_of_birth_mother')}}" autocomplete="off">
                                                <label>@lang('date of birth mother')</label>
                                                <span class="focus-border"></span>
                                                @if ($errors->has('date_of_birth_mother'))
                                                    <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('date_of_birth_mother') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-40 mt-30">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        <input class="primary-input form-control" cols="0" rows="3" name="mother_address" id="mother_address">{{old('mother_address')}}</input>
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        <input class="primary-input form-control" cols="0" rows="3" name="guardians_address" id="guardians_address">{{old('guardians_address')}}</input>
                            ...
                            <div class="row mb-30">
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        <input class="primary-input form-control{{ $errors->has('facebook_guardian') ? ' is-invalid' : '' }}" type="text" name="facebook_guardian" id="facebook_guardian" value="{{old('facebook_guardian')}}">
                                        ...
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input date form-control{{ $errors->has('date_of_birth_guardian') ? ' is-invalid' : '' }}" id="startDate" type="text"
                                                       name="date_of_birth_guardian" value="{{old('date_of_birth_guardian')}}" autocomplete="off">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        <input class="primary-input form-control{{ $errors->has('as_guardian') ? ' is-invalid' : '' }}" type="text" name="as_guardian" id="as_guardian" value="{{old('facebook_guardian')}}">
                                        <label>@lang('as')</label>
                                        <span class="focus-border"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-4">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    ...
                                    <input class=" form-control" cols="0" rows="3" name="emergency_name" id="emergency_name">{{old('emergency_name')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    ...
                                    <input class=" form-control" cols="0" rows="3" name="emergency_occupation" id="emergency_occupation">{{old('emergency_occupation')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    ...
                                    <input class=" form-control" cols="0" rows="3" name="emergency_mobiles" id="emergency_mobiles">{{old('emergency_mobile')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-4">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input form-control" cols="0" rows="3" name="village_school" id="village_school">{{old('village_school')}}</input>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input form-control" cols="0" rows="3" name="commune_school" id="commune_school">{{old('commune_school')}}</input>
                            ...
                            <div class="col-lg-4">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input form-control" cols="0" rows="3" name="district_school" id="district_school">{{old('district_school')}}</input>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input form-control" cols="0" rows="3" name="from_school" id="from_school">{{old('from_school')}}</input>
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('province') ? ' is-invalid' : '' }}" name="province_school">
                                    <option data-display="@lang('province')" value="">@lang('province')</option>
                                    @foreach($provinces as $province)
                                        <option value="{{$province->id}}" {{old('province_school') == $province->id? 'selected': ''}}>{{$province->name}}</option>
                                    @endforeach
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" type="number" name="degree_year" id="degree_year">{{old('degree_year')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="degree_no" id="degree_no">{{old('degree_no')}}</input>
                                  <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="subject1" id="subject1">{{old('subject1')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="grade1" id="grade1">{{old('grade1')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="subject2" id="subject2">{{old('subject2')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-6">
                                <label>@lang('Grade') <span></span> </label>
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="grade2" id="grade2">{{old('grade2')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="subject3" id="subject3">{{old('subject3')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-6">
                                <label>@lang('Grade') <span></span> </label>
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="grade3" id="grade3">{{old('grade3')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="subject4" id="subject4">{{old('subject4')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-6">
                                <label>@lang('Grade') <span></span> </label>
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="grade4" id="grade4">{{old('grade4')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="subject5" id="subject5">{{old('subject5')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-6">
                                <label>@lang('Grade') <span></span> </label>
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="grade5" id="grade5">{{old('grade5')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="subject6" id="subject6">{{old('subject6')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-6">
                                <label>@lang('Grade') <span></span> </label>
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" name="grade6" id="grade6">{{old('grade6')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <select class="w-100 niceSelect bb form-control{{ $errors->has('total_grade') ? ' is-invalid' : '' }}" name="total_grade">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class=" form-control" cols="0" rows="3" type="number" name="total_score" id="total_score">{{old('total_score')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <select class="w-100 niceSelect bb form-control{{ $errors->has('degree_level') ? ' is-invalid' : '' }}" name="degree_level">
                                        <option data-display="Select Level *" value="">@lang('lang.select_level') *</option>
                                        <option value="បាក់ឌុប"> បាក់ឌុប</option>
                                        <option value="សមមូល"> សមមូល</option>
                            ...
                            <div class="col-lg-6">
                                <option data-display="@lang('lang.category')" value="">@lang('Student Category')</option>
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <div class="sm2_mb_20 md_mb_20">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('category') ? ' is-invalid' : '' }}" name="category">
                                            @foreach($categories as $category)
                                                <option value="{{$category->id}}" {{old('category') == $category->id? 'selected': ''}}>{{$category->category_name}}</option>
                                            @endforeach
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-4">
                                    ...
                                    <input   class="form-control{{ $errors->has('house_student') ? ' is-invalid' : '' }}" cols="0" rows="3" name="house_student" id="house_student">{{old('house_student')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <input class="form-control{{ $errors->has('street_student') ? ' is-invalid' : '' }}" cols="0" rows="3" name="street_student" id="street_student">{{old('street_student')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <input class="form-control{{ $errors->has('group_student') ? ' is-invalid' : '' }}" cols="0" rows="3" name="group_student" id="group_student">{{old('group_student')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-4">
                                    ...
                                    <label>@lang('Village') <span></span> </label>
                                    <input   class="form-control{{ $errors->has('village_student') ? ' is-invalid' : '' }}" cols="0" rows="3" name="village_student" id="village_student">{{old('village_student')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <label>@lang('Commune')  <span></span> </label>
                                    <input class="form-control{{ $errors->has('commune_student') ? ' is-invalid' : '' }}" cols="0" rows="3" name="commune_student" id="commune_student">{{old('commune_student')}}</input>
                                    <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <label>@lang('District')  <span></span> </label>
                                    <input class="form-control{{ $errors->has('district_student') ? ' is-invalid' : '' }}" cols="0" rows="3" name="district_student" id="district_student">{{old('district_student')}}</input>
                                    <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-6">
                                ...
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('province_student') ? ' is-invalid' : '' }}" name="province_student">
                                    <option data-display="@lang('province')" value="">@lang('province')</option>
                                    @foreach($provinces as $province)
                                        <option value="{{$province->id}}" {{old('province_student') == $province->id? 'selected': ''}}>{{$province->name}}</option>
                                    @endforeach
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-4">
                                <label>@lang('House No') <span></span> </label>
                                <input   class="form-control{{ $errors->has('house_permanent') ? ' is-invalid' : '' }}" cols="0" rows="3" name="house_permanent" id="house_permanent">{{old('house_permanent')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                ...
                                <label>@lang('Street')  <span></span> </label>
                                <input class="form-control{{ $errors->has('street_permanent') ? ' is-invalid' : '' }}" cols="0" rows="3" name="street_permanent" id="street_permanent">{{old('street_permanent')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                ...
                                <label>@lang('Group')  <span></span> </label>
                                <input class="form-control{{ $errors->has('group_permanent') ? ' is-invalid' : '' }}" cols="0" rows="3" name="group_permanent" id="group_permanent">{{old('group_permanent')}}</input>
                                <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-4">
                                ...
                                <label>@lang('Village') <span></span> </label>
                                <input   class="form-control{{ $errors->has('village_permanent') ? ' is-invalid' : '' }}" cols="0" rows="3" name="village_permanent" id="village_permanent">{{old('village_permanent')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                ...
                                <label>@lang('Commune')  <span></span> </label>
                                <input class="form-control{{ $errors->has('commune_permanent') ? ' is-invalid' : '' }}" cols="0" rows="3" name="commune_permanent" id="commune_permanent">{{old('commune_permanent')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                ...
                                <label>@lang('District')  <span></span> </label>
                                <input class="form-control{{ $errors->has('district_permanent') ? ' is-invalid' : '' }}" cols="0" rows="3" name="district_permanent" id="district_permanent">{{old('district_permanent')}}</input>
                                <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-4">
                                ...
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('province_permanent') ? ' is-invalid' : '' }}" name="province_permanent">
                                    <option data-display="@lang('province')" value="">@lang('province')</option>
                                    @foreach($provinces as $province)
                                        <option value="{{$province->id}}" {{old('province_permanent') == $province->id? 'selected': ''}}>{{$province->name}}</option>
                                    @endforeach
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-4">
                                <label>@lang('House No') <span></span> </label>
                                <input   class="form-control{{ $errors->has('house_birth') ? ' is-invalid' : '' }}" cols="0" rows="3" name="house_birth" id="house_birth">{{old('house_birth')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                ...
                                <label>@lang('Group')  <span></span> </label>
                                <input class="form-control{{ $errors->has('group_birth') ? ' is-invalid' : '' }}" cols="0" rows="3" name="group_birth" id="group_birth">{{old('group_birth')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                ...
                                <label>@lang('Village') <span></span> </label>
                                <input   class="form-control{{ $errors->has('village_birth') ? ' is-invalid' : '' }}" cols="0" rows="3" name="village_birth" id="village_birth">{{old('village_birth')}}</input>
                                <span class="focus-border textarea"></span>
                        ...
                        <div class="row mb-30 mt-30">
                            ...
                            <div class="col-lg-4">
                                ...
                                <label>@lang('Commune')  <span></span> </label>
                                <input class="form-control{{ $errors->has('commune_birth') ? ' is-invalid' : '' }}" cols="0" rows="3" name="commune_birth" id="commune_birth">{{old('commune_birth')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                ...
                                <label>@lang('District')  <span></span> </label>
                                <input class="form-control{{ $errors->has('district_birth') ? ' is-invalid' : '' }}" cols="0" rows="3" name="district_birth" id="district_birth">{{old('district_birth')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-4">
                                ...
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" name="city">
                                    <option data-display="@lang('province')" value="">@lang('province')</option>
                                    @foreach($provinces as $province)
                                        <option value="{{$province->id}}" {{old('city') == $province->id? 'selected': ''}}>{{$province->name}}</option>
                                    @endforeach
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-3">
                                <label>@lang('Name') <span></span> </label>
                                <input   class="form-control{{ $errors->has('family1') ? ' is-invalid' : '' }}" cols="0" rows="3" name="family1" id="family1">{{old('family1')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-3">
                                ...
                                <input class="form-control{{ $errors->has('major1') ? ' is-invalid' : '' }}" cols="0" rows="3" name="major1" id="major1">{{old('major1')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-3">
                                ...
                                <input   class="form-control{{ $errors->has('academic1') ? ' is-invalid' : '' }}" cols="0" rows="3" name="academic1" id="academic1">{{old('academic1')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-3">
                                ...
                                <input   class="form-control{{ $errors->has('as1') ? ' is-invalid' : '' }}" cols="0" rows="3" name="as1" id="as1">{{old('as1')}}</input>
                                <span class="focus-border textarea"></span>
                                @if ($errors->has('as1'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-3">
                                <label>@lang('Name') <span></span> </label>
                                <input   class="form-control{{ $errors->has('family2') ? ' is-invalid' : '' }}" cols="0" rows="3" name="family2" id="family2">{{old('family2')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-3">
                                ...
                                <label>@lang('Major')  <span></span> </label>
                                <input class="form-control{{ $errors->has('major2') ? ' is-invalid' : '' }}" cols="0" rows="3" name="major2" id="major2">{{old('major2')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-3">
                                ...
                                <label>@lang('Academic') <span></span> </label>
                                <input   class="form-control{{ $errors->has('academic2') ? ' is-invalid' : '' }}" cols="0" rows="3" name="academic2" id="academic2">{{old('academic2')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-3">
                                ...
                                <label>@lang('As') <span></span> </label>
                                <input   class="form-control{{ $errors->has('as2') ? ' is-invalid' : '' }}" cols="0" rows="3" name="as2" id="as2">{{old('as2')}}</input>
                                <span class="focus-border textarea"></span>
                                @if ($errors->has('as2'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-3">
                                <label>@lang('Name') <span></span> </label>
                                <input   class="form-control{{ $errors->has('family3') ? ' is-invalid' : '' }}" cols="0" rows="3" name="family3" id="family3">{{old('family3')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-3">
                                ...
                                <label>@lang('Major')  <span></span> </label>
                                <input class="form-control{{ $errors->has('major3') ? ' is-invalid' : '' }}" cols="0" rows="3" name="major3" id="major3">{{old('major3')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-3">
                                ...
                                <label>@lang('Academic') <span></span> </label>
                                <input   class="form-control{{ $errors->has('academic3') ? ' is-invalid' : '' }}" cols="0" rows="3" name="academic3" id="academic3">{{old('academic3')}}</input>
                                <span class="focus-border textarea"></span>
                            ...
                            <div class="col-lg-3">
                                ...
                                <label>@lang('As') <span></span> </label>
                                <input   class="form-control{{ $errors->has('as3') ? ' is-invalid' : '' }}" cols="0" rows="3" name="as3" id="as3">{{old('as3')}}</input>
                                <span class="focus-border textarea"></span>
                                @if ($errors->has('as3'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="row mb-40">
                         ...
                         <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input" type="text" name="document_title_5" value="{{old('document_title_5')}}">
                                    <label>@lang('document 05 title')</label>
                                    <span class="focus-border"></span>
                                </div>
                            </div>
                        </div>
                         <div class="row mb-30">
                             ...
                             <div class="col-lg-3">
                                 <div class="row no-gutters input-right-icon">
                                     <div class="col">
                                         <div class="input-effect sm2_mb_20 md_mb_20">
                                             <input class="primary-input" type="text" id="placeholderFileFiveName" placeholder="05"
                                                    readonly="">
                                             <span class="focus-border"></span>
                                             @if ($errors->has('file'))
                                                 <span class="invalid-feedback d-block" role="alert">
