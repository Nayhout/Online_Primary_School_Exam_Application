                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="value">
                                        @if($student_detail->className!="" && $student_detail->session_id!="")
                                            ...
                                            ({{$academic_year->year}}-{{$academic_year->year+1}})
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="white-box">
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <?php
                                        $province = \App\SmProvinces::find($student_detail->city);
                                        ?>
                                        <div class="col-lg-10 col-md-7">
                                            <div class="">
                                                ផ្ទះលេខ : {{@$student_detail->house_birth}} &nbsp;&nbsp; ផ្លូវលេខ : {{$student_detail->group_birth}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ភូមិ : {{@$student_detail->village_birth}}  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ឃុំ-សង្កាត់ : {{@$student_detail->commune_birth?@$students->district_birth:''}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; រាជធានី-ខេត្ត : {{@$province->name_kh}}                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-6">
                                            <div class="">
                                                @lang('Student Type (External)')
                                            </div>
                                        </div>

                                        <div class="col-lg-7 col-md-7">
                                            <div class="">
                                                @if($student_detail->external == '1')
                                                    {{$student_detail->external == "External"? $student_detail->external:'External'}}
                                                    @else
                                                    {{$student_detail->external != "Internal"? $student_detail->external:'Internal'}}
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-7">
                                            <div class="">
                                                {{$student_detail->current_occupation_student != ""? $student_detail->current_occupation_student:""}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-7">
                                            <div class="">
                                                {{$student_detail->facebook_student != ""? $student_detail->facebook_student:""}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 col-md-7">
                                            <div class="">
                                                ផ្ទះលេខ : {{@$student_detail->house_student}} &nbsp;&nbsp; ផ្លូវលេខ : {{$student_detail->street_student}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ភូមិ : {{@$student_detail->village_student}}  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ឃុំ-សង្កាត់ : {{@$student_detail->commune_student?@$student_detail->district_student:''}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; រាជធានី-ខេត្ត : {{@$province->name_kh}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        <div class="col-lg-2 col-md-6">
                                            ...
                                            <?php
                                                $permanents = \App\SmStudentsPermanent::find($student_detail->student_permanent_id);
//                                                $p = \App\SmProvinces::find($permanents->province_permanent);
//                                                dd($permanents);
                                            ?>
                                        <div class="col-lg-10 col-md-7">
                                            <div class="">
                                                ផ្ទះលេខ : {{@$permanents->house_permanent}} &nbsp;&nbsp; ផ្លូវលេខ : {{@$permanents->street_permanent}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ភូមិ : {{@$permanents->village_permanent}}  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ឃុំ-សង្កាត់ : {{@$permanents->commune_permanent?@$permanents->district_permanent:''}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; រាជធានី-ខេត្ត : {{@$p->name_kh}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="single-info">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="">
                                                        @lang('Date of Birth Father')
                                                    </div>
                                                </div>

                                                <div class="col-lg-8 col-md-7">
                                                    <div class="">
                                                        {{$student_detail->parents->date_of_birth_father}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="single-info">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="">
                                                        @lang('Date of Birth Mother')
                                                    </div>
                                                </div>

                                                <div class="col-lg-8 col-md-7">
                                                    <div class="">
                                                        {{$student_detail->parents !=""?$student_detail->parents->date_of_birth_mother:""}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="single-info">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="">
                                                        @lang('Date of Birth Guardian')
                                                    </div>
                                                </div>

                                                <div class="col-lg-8 col-md-7">
                                                    <div class="">
                                                        {{$student_detail->parents !=""?$student_detail->parents->date_of_birth_guardian:""}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-info">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-7">
                                                    <div class="">
                                                        {{$student_detail->parents !=""?$student_detail->parents->facebook_guardian:""}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-info">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-7">
                                                    <div class="">
                                                        {{$student_detail->parents !=""?$student_detail->parents->as_guardian:""}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
{{--                                        </div>--}}
                                ...
                                <!-- Start High School Info -->
                                <!-- Created 02-02-2021 SONG SOPHEAK-->
                                <h4 class="stu-sub-head mt-40">@lang('high school info')</h4>
                                @if(isset($student_detail->village_school))
                                    @if(!empty($student_detail->village_school) || !empty($student_detail->commune_school) || !empty($student_detail->district_school) || !empty($student_detail->from_school))

                                        <div class="single-info">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-6" style="color: black">
                                                    <div class="">
                                                        Village / ភូមិ : {{isset($student_detail->village_school)? $student_detail->village_school: ''}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Commune / ឃុំ : {{isset($student_detail->commune_school)?$student_detail->commune_school:''}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  District / សង្កាត់ : {{isset($student_detail->district_school)?$student_detail->district_school:''}}
                                        ...
                                        <div class="single-info">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-6" style="color: black">
                                                    <div class="">
                                                        <?php
                                                        $provinces = \App\SmProvinces::find($student_detail->province_school);
                                                        ?>
                                                            From High School / មកពីសាលា: {{isset($student_detail->from_school)?$student_detail->from_school:''}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Province / ខេត្ត : {{isset($student_detail->province_school)? optional($provinces)->name:''}}
                                ...
                                <!-- End High School Info -->

                                <!-- Start DEGREE INFO Info -->
                                <!-- Created 02-02-2021 SONG SOPHEAK-->

                                <h4 class="stu-sub-head mt-40" style="color: #0a0302"><b>@lang('degree info')</b></h4>

                                        <div class="single-info">
                                            <div class="row">
                                                <div class="col-lg-8 col-md-5" style="color: black">
                                                    <div class="">
                                                        <s1 style="float: left"> @lang('Degree Year') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->degree_year}} </s1>
                                                        <s2 style="float: right">@lang('Degree No') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->degree_no}}</s2>
                                                    </div>
...
{{--                                                        {{isset($student_detail->)}}--}}
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-5" style="color: black">
                                            <div class="" width="40%">
                                                <div style="float: left"> @lang('Subject 1') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$student_detail->subject1}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
                                                <div style="float: left" >@lang('Grade 1') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->grade1}} </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-5" style="color: black">
                                            <div class="" width="20%">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5" style="color: black">
                                            <div class="" width="40%">
                                                <div style="float: left" >@lang('Subject 2') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$student_detail->subject2}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
                                                <div style="float: left" >@lang('Grade 2') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->grade2}}</div>
                                            </div>
                                        </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-5" style="color: black">
                                            <div class="" width="40%">
                                                <div style="float: left"> @lang('Subject 3') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$student_detail->subject3}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
                                                <div style="float: left" >@lang('Grade 3') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->grade3}} </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-5" style="color: black">
                                            <div class="" width="20%">
                                        ...
                                        <div class="col-lg-5 col-md-5" style="color: black">
                                            <div class="" width="40%">
                                                <div style="float: left" >@lang('Subject 4') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$student_detail->subject4}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
                                                <div style="float: left" >@lang('Grade 4') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->grade4}}</div>
                                            </div>
                                        </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-5" style="color: black">
                                            <div class="" width="40%">
                                                <div style="float: left"> @lang('Subject 5') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$student_detail->subject5}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
                                                <div style="float: left" >@lang('Grade 5') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->grade5}} </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-5" style="color: black">
                                            <div class="" width="20%">
                                        ...
                                        <div class="col-lg-5 col-md-5" style="color: black">
                                            <div class="" width="40%">
                                                <div style="float: left" >@lang('Subject 6') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$student_detail->subject6}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
                                                <div style="float: left" >@lang('Grade 6') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->grade6}}</div>
                                            </div>
                                        </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-5" style="color: black">
                                                <div class="" width="50%">
                                                    <div style="float: left" >@lang('Total Grade') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->total_grade}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                                                    <div style="float: left" >@lang('Total Score') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$student_detail->total_score}}</div>
                                                </div>
                                            </div>
                                            <div class="" width="50%" style="color: black">
                                                <div style="float: left"> </div>
                                                <div style="text-align: center;float: right;margin-right: 310px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   @lang('Degree Level'): &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->degree_level}}</div>
                                            </div>
                                        </div>
                                ...
                                <!-- End DEGREE INFO Info -->

                                <!-- Start DEGREE INFO Info -->
                                <!-- Created 02-02-2021 SONG SOPHEAK-->
                                <h4 class="stu-sub-head mt-40" style="color: #0a0302"><b>@lang('student address permanent')</b></h4>
                                <div class="single-info">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-5" style="color: #0a0302">
                                            <div class="">
                                                @lang('House No') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$student_detail->house_student}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; @lang('Street') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->street_student}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; @lang('Group') :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->group_student}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; @lang('Village') :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->village_student}}
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-5" style="color: #0a0302">
                                            <div class="">
                                                <?php
                                                    $provinces = \App\SmProvinces::find($student_detail->province_student);
                                                ?>
                                                @lang('Commune') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$student_detail->commune_student}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; @lang('District') : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$student_detail->district_student}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                @lang('Province') :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{optional($provinces)->name}}
                                            </div>
                                        </div>
