...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('List Student Private') </h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.reports')</a>
                <a href="#">@lang('List Student Private')</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <div class="white-box">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'student_private', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                            <div class="row">
                                ...
                                <div class="col-lg-3 mt-30-md">
                                    <select class="w-100 niceSelect bb form-control {{ $errors->has('faculty') ? ' is-invalid' : '' }}" id="select_faculty" name="faculty">
                                        ...
                                        @foreach($faculties as $faculty)
                                            <option value="{{$faculty->name}}"  {{isset($faculty_id)? ($faculty_id == $faculty->name? 'selected':''):''}}>{{@$faculty->name}}</option>
                                        @endforeach
                                    </select>
