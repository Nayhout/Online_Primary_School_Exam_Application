...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0" style="color: black">
                                    ...
                                    <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="input-effect">
                                                        <input class="primary-input form-control{{ $errors->has('percentage') ? ' is-invalid' : '' }}"
                                                               type="text" name="percentage" autocomplete="off" value="{{isset($student_type)? $student_type->percentage:''}}">
                                                        <input type="hidden" name="id" value="{{isset($student_type)? $student_type->id: ''}}">
                                                        <label>@lang('lang.percentage') <span>*</span></label>
                                                        <span class="focus-border"></span>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="input-effect">
                                                        <input class="primary-input form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
                                                               type="text" name="description" autocomplete="off" value="{{isset($student_type)? $student_type->description:''}}">
                                                        <input type="hidden" name="id" value="{{isset($student_type)? $student_type->id: ''}}">
                                        ...
                                        <div class="row mt-40">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="input-effect">
                                                        <input class="primary-input form-control{{ $errors->has('fix_amount') ? ' is-invalid' : '' }}"
                                                               type="text" name="fix_amount" autocomplete="off" value="{{isset($student_type)? $student_type->fix_amount:''}}">
                                                        <input type="hidden" name="id" value="{{isset($student_type)? $student_type->id: ''}}">
                                                        <label>@lang('fix amount')</label>
                                                        <span class="focus-border"></span>
                                                        @if ($errors->has('fix_amount'))
                                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('fix_amount') }}</strong>
                                            </span>
                                                        @endif
                                                    </div>
                                                </div>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$student_type->percentage}}</td>
                                    <td>{{$student_type->categories_description}}</td>
                                    <td>{{$student_type->fix_amount}}</td>
                                    <td>
                                        <div class="dropdown">
