        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{url('student-promote')}}">@lang('lang.student_promote')</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('current_session') ? ' is-invalid' : '' }}"
                                        name="current_session" id="current_session">
                                    <option data-display="@lang('lang.select_academic_year') *"
                                            value="">@lang('lang.select_academic_year') *
                                    </option>
                                    @foreach($sessions as $session)
                                        <option value="{{$session->id}}" {{isset($current_session)? ($current_session == $session->id? 'selected':''):''}}>{{$session->year}}
                                            -{{$session->year+1}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-3 mt-30-md">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('current_class') ? ' is-invalid' : '' }}"
                                        id="c_select_class" name="current_class">
                                    <option data-display="@lang('lang.select_current_class') *"
                                            value="">@lang('lang.select_current_class') *
                                    </option>
                            ...
                            <div class="col-lg-2 mt-30-md" id="c_select_section_div">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('section') ? ' is-invalid' : '' }}"
                                        id="c_select_section" name="section">
                            ...
                            <div class="col-lg-2 mt-30-md">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('result') ? ' is-invalid' : '' }}"
                                        name="result">
                                ...
                                <table class="display school-table school-table-style" cellspacing="0" width="100%">
                                    ...
                                    @foreach( @$students['students'] ? @$students['students']: $students  as $student)
                                        ...
                                        @php
                                            ...
                                            $class = \App\SmClass::find($student['class_id']);
...
{{--                                            <td>{{@@$student->studentinfo ? @$student->studentinfo->first_name .' '.@$student->studentinfo->last_name : @$student->first_name .' '.@$student->last_name}}</td>--}}
                                            ...
                                            <td>
                                                @if (@$student->result!='F')
                                                    <input type="text" hidden name="result[{{@$student->id}}]"
                                                           value="P">
                                                    @lang('lang.pass')
                                                @else
                                                    <input type="text" hidden name="result[{{@$student->id}}]"
