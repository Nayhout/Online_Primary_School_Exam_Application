...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('List Student Scholarship') </h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.reports')</a>
                <a href="#">@lang('List Student Scholarship')</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <div class="white-box">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'student_scholarship', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                            <div class="row">
                                ...
                                <div class="col-lg-3 mt-30-md">
                                    <select class="w-100 niceSelect bb form-control {{ $errors->has('faculty') ? ' is-invalid' : '' }}" id="select_faculty" name="faculty">
                                        ...
                                        @foreach($faculties as $faculty)
                                            <option value="{{$faculty->faculty_name}}"  {{isset($faculty_id)? ($faculty_id == $faculty->faculty_name? 'selected':''):''}}>{{@$faculty->faculty_name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-3 mt-30-md">
                                    <select class="w-100 niceSelect bb form-control {{ $errors->has('major') ? ' is-invalid' : '' }}" id="select_major" name="major">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0">@lang('List Student Scholarship')</h3>
                            </div>
                        </div>
                    </div>
