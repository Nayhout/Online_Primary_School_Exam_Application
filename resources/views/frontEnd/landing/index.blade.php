...
[ {
  ...
  "name" : "CLOUD - Best School Management software system",
  "url" : "",
  "author" : {
    "@type" : "Company",
    "name" : "Spondon IT"
  ...
  "review" : {
    ...
    "reviewBody" : "Query\n                                Account"
        ...
        <meta name="twitter:site" content="@CloudNet"/>
        <meta name="twitter:creator" content="@CloudNet"/>
                    ...
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <p>Managing various administrative tasks in one place is now quite easy and time
                                savior with this CloudNet and Give your valued time to your institute that will
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>CLOUD has all in one place. You’ll find everything what you are looking into education
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>You know! Smart Idea always comes to well planners. And Our CLOUD is Smart for its Well
                                Documentation.
                            </p>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="video_section_text">
                        <h2>Take A look Our CLOUD Overview in Video</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <p>We Believe! It won’t a wrong decision in Purchasing our CLOUD for your Institute.</p>
